  ...
  return (
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        <li
          className={`menu-item ${getMenuItemActive("/myLog", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/myLog">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")} />
            </span>
            <span className="menu-text">My Log</span>
          </NavLink>
        </li>

        <li
          className={`menu-item ${getMenuItemActive("/team", false)}`}
          aria-haspopup="true"
        >
        ...
        <li
          className={`menu-item ${getMenuItemActive("/todos", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/todos">
            ...
            <span className="menu-text">Todo's</span>
          </NavLink>
        </li>

        <li
          className={`menu-item ${getMenuItemActive("/logReport", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/logReport">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")} />
            </span>
            <span className="menu-text">Log Report</span>
          </NavLink>
        </li>
